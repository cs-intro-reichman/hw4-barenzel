...
public class ArrCharOps {
    ...
    public static boolean equals(char[] arr1, char[] arr2) {
        if (arr1 == null && arr2 == null) {
            return true; 
        } else if (arr1.length != arr2.length || arr1 == null || arr2 == null) {
            return false; 
        } else {
    ...
    */
    ...
    public static long hashCode(char[] arr) {
        ...
        int i = 0;
        while ((i < arr.length) && (power >= 0)) {
            res = res + arr[i] * (long) (Math.pow(7, power));
            i++;
            power--;
        }
        return res;
    ...
    public static int compareTo(String str1, String str2) {
        ...
        for (int i = 0; i < min; i++) {
            if (str1.charAt(i) == str2.charAt(i)) {
                ...
                answer =(str1.charAt(i) < str2.charAt(i)) ? -1 : 1;
                return answer;
            }
